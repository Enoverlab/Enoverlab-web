  ...
  return (
    <CardStyle>
      <PricingCard
        ...
        textColor={theme.color.dark}
        cardText={[
          "With Just ", <b>4 weeks</b>," learn the required knowledge, skills and tools to fully take up the role of a product manager"]
        }
        tuitionFee={"₦200,000"}
        duration={"$49.00"}
        mobileHeight={"100%"}
      ...
      >
        <P fontSize="1.25rem" textAlign="left" color={theme.color.dark} fontWeight="600" paddingBottom="1.5rem"> 
...
export const OnsiteCard = () => {
  ...
  return (
    <CardStyle>
      ...
      >
          <P fontSize="1.25rem" textAlign="left" color={theme.color.dark} fontWeight="600" paddingBottom="1.5rem"> 
        What is included in Advanced (On-site)?
        </P>
